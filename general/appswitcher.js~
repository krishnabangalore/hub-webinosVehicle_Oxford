...
$(document).ready(function() {
	...
	createAppEntry(1, 'webinos travel', '../../travel-manager/general/images/icon.png', '../../travel-manager/automotive/index.html');
	createAppEntry(2, 'trip computer', '../../travel-manager/tripcomputer_review/icon.png', '../../travel-manager/tripcomputer_review/tripcomputer.html');
